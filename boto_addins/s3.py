...
class AsyncS3Connection(S3Connection):
    ...
    def set_contents_from_file(self, bucket, key_name, fp, headers=None,
...
class AsyncBucket(Bucket):
    ...
    def get_key_contents(self, key_name, attempts=3, **kwargs):
        return self.connection.generate_request(
